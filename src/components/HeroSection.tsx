...
const HeroSection = () => {
  return (
    <section className="min-h-screen flex items-center bg-gradient-background relative overflow-hidden">
      ...
      <div className="absolute bottom-20 right-10 w-40 h-40 bg-gradient-secondary rounded-full blur-3xl opacity-20 floating" style={{animationDelay: '2s'}}></div>
      <div className="absolute top-1/2 left-1/3 w-24 h-24 bg-gradient-accent rounded-full blur-3xl opacity-15 floating" style={{animationDelay: '4s'}}></div>
